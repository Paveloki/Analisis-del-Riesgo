...
Como el valor del estadístico es de -1.696484, eso quiere decir que no es mayor al 2.3295, entonces no podemos rechazar Ho. En conclusión la media del rendimiento diario, es estadisticamente igual a cero.
...
Igual que antes no podemos rechazar Ho. El rendimiento es estadísticamente diferente de 0, se podría asumir que son insignificantes.
...
Usando MU y SIGMA en términos diarios, tenemos:
...
Para dias dt = 10. Para el valor inicial So, vamos a usar el último día de información disponible.
...
simula
```
La suma de esos dos valores sería el valor ESperado

Intérvalo de confianza al 95%
